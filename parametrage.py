...
class Parametrage(Frame):
    ...
    def __init__(self, fenetre, skribbl, **kwargs):
        ...
        self.crayon = StringVar(value = 3)
        self.petit_crayon = Radiobutton(self, text="petit", variable=self.crayon, value="3")
        self.moyen_crayon = Radiobutton(self, text="moyen", variable=self.crayon, value="7")
        self.grand_crayon = Radiobutton(self, text="grand", variable=self.crayon, value="19")
        self.tres_grand_crayon = Radiobutton(self, text="tres grand", variable=self.crayon, value="40")
